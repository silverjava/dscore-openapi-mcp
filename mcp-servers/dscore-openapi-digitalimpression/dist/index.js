...
const digitalimpressionService_1 = require("./digitalimpressionService");
...
async function main() {
    ...
    server.registerTool('list-digital-impressions', 'List digital impressions in the DS Core Open API system with pagination and filtering support. Note: The filter parameter only supports patient.id and create_time filters. Example filters: patient.id="1234" and create_time > "2021-01-01T00:00:00Z" and create_time < "2021-01-31T23:59:59Z"', {
        pageSize: 'number',
        pageToken: 'string',
        filter: 'string'
    }, async (args) => {
        ...
        try {
            ...
            const result = await (0, digitalimpressionService_1.listDigitalImpressionsRemote)(params);
            return result;
        }
        catch (error) {
    ...
    server.registerTool('get-digital-impression', 'Get a digital impression by ID from the DS Core Open API system', {
        ...
        try {
            ...
            const digitalImpression = await (0, digitalimpressionService_1.getDigitalImpressionRemote)(digitalImpressionId);
